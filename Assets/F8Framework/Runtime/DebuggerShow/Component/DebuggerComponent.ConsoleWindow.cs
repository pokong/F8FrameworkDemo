...
namespace DebuggerShow
{
    public sealed partial class DebuggerComponent
    {
        ...
        private sealed class ConsoleWindow : IDebuggerWindow
        {
            ...
            {
#if UNITY_EDITOR
                get { return $"{Application.dataPath}/../LogsShow/"; }
#else
                get { return $"{Application.persistentDataPath}/LogsShow/"; }
#endif
            }
            ...
            {
#if UNITY_EDITOR
                get { return $"/LogShow_{System.DateTime.Now.ToString("yyyy-mm-dd-HH-mm-ss")}.txt"; }
#else
                get { return $"/LogShow_{System.DateTime.Now.ToString("yyyy-mm-dd-HH")}.txt"; }
#endif
            }
        }
    }
