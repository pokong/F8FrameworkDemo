...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class SubtitlesUGUI : MonoBehaviour
	{
		...
		[SerializeField] TMPro.TextMeshProUGUI _textpro = null;
		...
		private void UpdateBackgroundRect()
		{
			if (_backgroundImage)
			{
				if (string.IsNullOrEmpty(_textpro.text))
				{
				...
				else
				{
					...
					_backgroundImage.rectTransform.sizeDelta = _textpro.rectTransform.sizeDelta;
					_backgroundImage.rectTransform.anchoredPosition = _textpro.rectTransform.anchoredPosition;
